...
- Node.js 24.18.0 LTS.
- Angular 22.0.6.
- Angular Material/CDK 22.0.4.
- TypeScript 6.0.3, the latest stable version in Angular 22.0.6's supported `>=6.0 <6.1` peer range.
- RxJS 7.8.2.
- Playwright 1.61.1.

## Consequences

- Local development requires Node 24 and Docker. The current machine has Node 20.20.0 and no Docker, so frontend and PostgreSQL runtime validation require environment updates.
