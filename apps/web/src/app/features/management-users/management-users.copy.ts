...
export const USERS_COPY: Record<Language, Record<string, string>> = {
  en: {
    ...
    setPassword: "Set / reset password", pin: "Employee PIN", pinHelp: "Exactly 6 digits. The value is never displayed again.", setPin: "Set / reset PIN", pinNotice: "PIN updated and active sessions revoked.", activate: "Activate user", suspend: "Suspend user", suspendHeading: "Suspend this user?",
  ...
  ar: {
    ...
    setPassword: "تعيين / إعادة ضبط كلمة المرور", pin: "رمز الموظف", pinHelp: "ستة أرقام بالضبط. لن تُعرض القيمة مرة أخرى.", setPin: "تعيين / إعادة ضبط الرمز", pinNotice: "تم تحديث الرمز وإلغاء الجلسات النشطة.", activate: "تنشيط المستخدم", suspend: "إيقاف المستخدم", suspendHeading: "إيقاف هذا المستخدم؟",
